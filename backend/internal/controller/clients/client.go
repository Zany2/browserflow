...
func queryBannedClientRecord(ctx context.Context, clientIP string) (gdb.Record, error) {
...
func getRequestClientIP(ctx context.Context) string {
...
func notifyClientBanned(ctx context.Context, clientIP string, clientID string, reason string) int {
	clientIP = strings.TrimSpace(clientIP)
	if clientIP == "" {
		return 0
	}
...
func closeClientConnection(ctx context.Context, clientIP string) int {
	clientIP = strings.TrimSpace(clientIP)
	if clientIP == "" {
		return 0
	}
