...
// BrowserInstanceStop stops browser instance 停止浏览器实例
func (c *ControllerV1) BrowserInstanceStop(ctx context.Context, req *v1.BrowserInstanceStopReq) (res *v1.BrowserInstanceStopRes, err error) {
	...
	if state.BrowserCurrentInstanceID == instanceID {
	...
	return &v1.BrowserInstanceStopRes{Status: &status}, nil
}
