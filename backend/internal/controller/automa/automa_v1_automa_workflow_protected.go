...
// AutomaWorkflowProtected updates local workflow protected status 修改本地工作流保护状态
func (c *ControllerV1) AutomaWorkflowProtected(ctx context.Context, req *v1.AutomaWorkflowProtectedReq) (res *v1.AutomaWorkflowProtectedRes, err error) {
	state.DBMu.Lock()
	if state.DB == nil {
	...
	return &v1.AutomaWorkflowProtectedRes{}, nil
}
