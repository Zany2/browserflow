...
// AutomaWorkflowUpdate updates local workflow metadata 修改本地工作流元信息
func (c *ControllerV1) AutomaWorkflowUpdate(ctx context.Context, req *v1.AutomaWorkflowUpdateReq) (res *v1.AutomaWorkflowUpdateRes, err error) {
	state.DBMu.Lock()
	if state.DB == nil {
	...
	return &v1.AutomaWorkflowUpdateRes{}, nil
}
