...
// AutomaWorkflowRun runs workflow through browser agent 运行工作流
func (c *ControllerV1) AutomaWorkflowRun(ctx context.Context, req *v1.AutomaWorkflowRunReq) (res *v1.AutomaWorkflowRunRes, err error) {
	state.AgentMu.Lock()
