...
// AutomaWorkflowImportFiles imports workflows from zip 导入 ZIP 中的工作流
func (c *ControllerV1) AutomaWorkflowImportFiles(ctx context.Context, req *v1.AutomaWorkflowImportFilesReq) (res *v1.AutomaWorkflowImportFilesRes, err error) {
	if req.File == nil {
	...
	stats := v1.AutomaWorkflowMutationStats{}
	...
	return &v1.AutomaWorkflowImportFilesRes{AutomaWorkflowMutationStats: stats}, nil
}
